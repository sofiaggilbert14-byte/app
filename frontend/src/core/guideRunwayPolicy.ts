 ...
 * Default is eight pages ahead / two behind; Compatibility (weak) shortens the
 * ahead band so weaker devices do less SQLite/bridge work while surfing.
